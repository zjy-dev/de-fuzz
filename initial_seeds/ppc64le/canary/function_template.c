 ...
 *
 * IMPORTANT FOR PPC64LE / ELFv2:
 *   Stack frames include LR/CR/TOC/save areas, and VLA / alloca can change
 *   the relative placement between saved state, local buffers, and the canary.
 *
