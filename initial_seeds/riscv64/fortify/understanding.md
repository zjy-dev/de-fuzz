# FORTIFY oracle initial seeds (riscv64)

> NOTE: The disasm-based checkers (INV-FORT-O01 / O02 / O03) currently
> NA-out on riscv64 because `internal/oracle/fortify_disasm.go` only
> wires up an x86_64 backend today. The symbol-level (W01-presence,
> C02) and dynamic (R01, R02, C01) checkers do run on riscv64.
