...
The confirmed-bug seed pool is small, so we amplify it by transferring root
causes \emph{across} mechanisms. We deliberately reject entity-driven retrieval
